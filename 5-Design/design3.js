...
let myIconBars1 = document.querySelector(".bars1")
let myClose1Icon = document.querySelector(".bars3 .close-cart")


let links = document.querySelector(".links");
let myIconBars2 = document.querySelector(".bars2")
let mySwiper = document.querySelector(".swiper")
let myBody = document.querySelector("body")

console.log(myIconBars1)
console.log(myIconBars2)
